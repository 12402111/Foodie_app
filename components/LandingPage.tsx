...
export function LandingPage({ onSelectRole }: LandingPageProps) {
  const [selectedRole, setSelectedRole] = useState<"student" | "canteen">(
    "student"
  );
  ...
  const handleAuthenticate = () => {
    ...
    if (selectedRole === "student") {
      ...
      if (mode === "signup" && studentPassword !== studentPasswordConfirm) {
    ...
    if (selectedRole === "canteen") {
      if (!managerToken.trim() || !managerPassword) {
        setError("Please enter manager token and password.");
        return;
      }
      onSelectRole("canteen");
      resetForm();
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Skip the queues, save your time. Pre-order your favorite campus
            meals and pick them up when ready!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
          ...
          <div
            ...
            className="group cursor-pointer bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border-2 border-transparent hover:border-orange-500 transform hover:-translate-y-2"
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-6">
                Browse menu, pre-order meals, and skip the queue with smart
                pickup times
              </p>
          ...
          {/* Canteen Card */}
          <div
            onClick={() => setSelectedRole("canteen")}
            className="group cursor-pointer bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border-2 border-transparent hover:border-purple-500 transform hover:-translate-y-2"
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-6">
                Manage orders efficiently with priority queue and analytics
                dashboard
              </p>
              <div className="space-y-2 text-sm text-left w-full">
                <div className="flex items-center gap-2 text-gray-700">
        ...
        <div className="max-w-2xl mx-auto bg-white/90 p-6 rounded-xl shadow-lg mb-12">
            ...
            <div className="space-x-2">
              <button
                ...
                className={`px-3 py-1 rounded ${
                  mode === "login" ? "bg-gray-900 text-white" : "bg-gray-100"
                }`}
              >
                Login
              </button>
              <button
                ...
                className={`px-3 py-1 rounded ${
                  mode === "signup" ? "bg-gray-900 text-white" : "bg-gray-100"
                }`}
              >
                Sign Up
              </button>
          ...
          <div>
            {selectedRole === "student" ? (
              ...
              <div className="space-y-3">
                <div>
                  <label className="text-sm text-gray-700">Manager Token</label>
                  <input
                    value={managerToken}
